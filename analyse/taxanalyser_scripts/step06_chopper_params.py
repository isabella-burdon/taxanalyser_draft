...
# get data
input_directory = f'{analysis_output_path}/data/QCMetrics'
...
parsing quality metrics for {folder}""")
    ...
    for file in os.listdir(html_path):
        if file.endswith('.html'):
            ...
            # print to text file
            with open(f'{analysis_output_path}/data/QCMetrics/chopper_lengths/{folder}_nanoQClengths.txt', 'w') as f:
